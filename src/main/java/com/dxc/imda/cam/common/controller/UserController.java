...
import com.dxc.imda.cam.igms.controller.IgmsUserController;
...
public class UserController {
	...
	@Autowired
	private IgmsUserController igmsUserController;
	...
	public ResponseEntity<Object> getUserInfo(HttpServletRequest request, 
		...
		if (igmsAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = igmsUserController.getUserInfo(request, response, reqParamMap, reqBodyMap);
		}	
	...
	public ResponseEntity<Object> getUserInfoList(HttpServletRequest request, 
		...
		if (igmsAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = igmsUserController.getUserInfoList(request, response, reqParamMap, reqBodyMap);
		}	
	...
	public ResponseEntity<Object> updateUser(HttpServletRequest request, 
		...
		if (igmsAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = igmsUserController.updateUser(request, response, reqParamMap, reqBody);
		}	
	...
	public ResponseEntity<Object> removeUser(HttpServletRequest request, 
		...
		if (igmsAccountId.equalsIgnoreCase(accountId)) {
			responseEntity = igmsUserController.removeUser(request, response, reqParamMap, reqBodyMap);
		}	
