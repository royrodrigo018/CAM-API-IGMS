package com.dxc.imda.cam.igms.entity;
...
public class IgmsCamApiAudit implements Serializable{
	...
	public String toString() {
		return "IgmsCamApiAudit [auditId=" + auditId + ", resource=" + resource + ", requestUri=" + requestUri
